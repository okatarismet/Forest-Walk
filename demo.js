...
function init(){
    ...
    flameLight.shadowCameraFar = 2500;
    flameLight.distance = 25
    flameLight.shadowCameraFar = 2500;
    flameLight.shadowMapWidth = 4096; // default is 512
    flameLight.shadowMapHeight = 4096; // default is 512
...
var update = () => {
    ...
    bindd(fireStick,flameLight,[0,2,0])
    ...
    // }
    // if(binded['fire'] == 1){
    //     bindz(player1,fireStick,[0,0,0]);
    //     document.getElementById('info3').innerHTML = "Press T to drop item"
    // } else{
    //     fall(fireStick,GRAVITY1)
    // }
    // if(keyboard[84]){
    //     binded['jarid'] = 0;
    //     document.getElementById('info3').innerHTML = ""
    ...
    if(binded['axe'] === 1){
        bindd(player1,meshes["axe"],[0,0,0]);
        document.getElementById('info3').innerHTML = "Press T to drop item"
    } else{
        fall(meshes["axe"],GRAVITY1)
    }
